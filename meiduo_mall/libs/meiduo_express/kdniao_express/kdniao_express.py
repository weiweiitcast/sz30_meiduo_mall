...
class KDNiaoExpress(metaclass=abc.ABCMeta):
    __key_value = KDNIAO_GLOBAL_SETTINGS.get("APIKey")
    __ebusiness_id = KDNIAO_GLOBAL_SETTINGS.get("EBUSINESS_ID")
    __char_set = KDNIAO_GLOBAL_SETTINGS.get("CHAR_SET")

    def __init__(self):
        assert self.__key_value, "please set APIKey in global setting"
